...
По этой таблице можно сформировать ещё 5 тест-кейсов для проверки модуля авторизации и переходов на различные страницы онлайн-магазина. 

## 📊 Результаты тестирования 

🔹 В чеклисте тестирования содержатся основные проверки для логина и регистрации, сформированные изначально на основе пользовательских историй. Это - база для дальнейшего более подробного тестирования.

🔹 Проверки из чеклиста были дополнены проведенным выше анализом в соответствии с техниками тест-дизайна, и затем я разработала тест-кейсы для полноценного тестирования логина и регистрации онлайн магазина.

🔹 В итоге получилось: 24 тест-кейса для ручного функционального тестированиия и 7 баг-репортов. 

🔹 Вся тестовая документация к этому проекту собрана в папке [test-artifacts](test-artifacts), а также по ссылке ниже:

[Ссылка на гугл-таблицу](https://docs.google.com/spreadsheets/d/1PDB1S-JbiSdGEvUOIi5YzPj1P6BV81LnLYyTL4tWFMU/edit?usp=sharing) 
