...
#### Форма логина - комбинированная проверка
...
|---|----------|----------------|---------------------|
| 1 | Регистрация, Логин | Валидный логин | ✅ Регистрация успешна |
| 2 | Регистрация, Логин  | Логин с недопустимыми символами | ❌ Сообщение об ошибке |
| 3 | Регистрация, Логин  | Пустое поле логина | ❌ Сообщение об ошибке |
| 4 | Регистрация, Логин  | Граничное значение: 3 валидных символа | ✅ Регистрация успешна |
| 5 | Регистрация, Логин  | Граничное значение: 15 валидных символов | ✅ Регистрация успешна |
| 6 | Регистрация, Логин  | Граничное значение: 2 валидных символа | ❌ Сообщение об ошибке |
| 7 | Регистрация, Логин  | Граничное значение: 16 валидных символов | ❌ Сообщение об ошибке |
| 8 | Регистрация, Пароль | Валидный пароль | ✅ Регистрация успешна |
| 9 | Регистрация, Пароль | Пароль без букв (только цифры), гр. значение 8 символов | ❌ Сообщение об ошибке |
| 10 | Регистрация, Пароль | Пароль без цифр (только буквы), гр. значение 8 символов | ❌ Сообщение об ошибке |
| 11 | Регистрация, Пароль | Пустое поле пароля | ❌ Сообщение об ошибке |
| 12 | Регистрация, Пароль | Граничное значение: 8 валидных символов | ✅ Регистрация успешна |
| 13 | Регистрация, Пароль | Граничное значение: 9 валидных символов | ✅ Регистрация успешна |
| 14 | Регистрация, Пароль | Граничное значение: 7 валидных символов  | ❌ Сообщение об ошибке |
| 15 | Вход, Логин и Пароль | Ввод логина и пароля зарегистрированного пользователя  | ✅ Успешный вход|
| 16 | Вход, Логин и Пароль | Ввод невалидного пароля и логина зарегистрированного пользователя  | ❌ Сообщение об ошибке |
| 17 | Вход, Логин и Пароль | Ввод невалидного логина и пароля зарегистрированного пользователя  | ❌ Сообщение об ошибке |
| 18 | Вход, Логин и Пароль | Ввод логина и пароля незарегистрированного пользователя  | ❌ Сообщение об ошибке |
| 19 | Вход, Логин и Пароль | Попытка входа с незаполненными полями логина и пароля  | ❌ Сообщение об ошибке |
